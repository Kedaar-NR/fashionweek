  ...
  return (
    <main className="container py-12 px-4" id="brand-gallery">
      <motion.div 
        ...
        className="mb-6 flex flex-col items-center gap-2 p-6 rounded-xl bg-white shadow-sm border border-[#eaeaea]"
      >
        <h2 className="text-2xl font-bold tracking-tight text-[#111]">
          {viewMode === 'table' ? (
            <span className="flex items-center">
              Upcoming Drops <Flame className="ml-2 text-[#F97316]" size={22} />
            </span>
          ) : 'Brand Gallery'}
        </h2>
